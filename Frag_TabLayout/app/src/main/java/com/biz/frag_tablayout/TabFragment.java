package com.biz.frag_tablayout;
...
public class TabFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        vp.setAdapter(new TabPageAdapter(getFragmentManager()));
    ...
    private class TabPageAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position){
                case 0 : return TabPage1Fragment.newInstance("TAB1","첫번째 페이지");
                case 1 : return TabPage1Fragment.newInstance("TAB2","두번째 페이지");
                case 2 : return TabPage1Fragment.newInstance("TAB3","세번째 페이지");
            }
            return null;
        }
